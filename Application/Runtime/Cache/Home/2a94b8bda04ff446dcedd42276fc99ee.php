...
<body>
<div class="container">
    <?php if(is_array($dirs['file'])): $i = 0; $__LIST__ = $dirs['file'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$file): $mod = ($i % 2 );++$i; echo ($file); endforeach; endif; else: echo "" ;endif; ?>
